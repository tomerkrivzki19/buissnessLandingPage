        ...
        <div className="bg-gray-50 py-24 sm:py-32">
          <div className="mx-auto max-w-md px-6 sm:max-w-lg lg:max-w-7xl lg:px-8">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-center text-xl text-gray-500">
              פנייה ושאלות נפוצות. נשמח לשמוע מכם! השאירו פרטים ונחזור בהקדם
              האפשרי.
            </p>
          </div>
        </div>
            ...
            <div className="lg:pl-8">
              <div className="mx-auto max-w-md sm:max-w-lg lg:mx-0">
                ...
                <p className="mt-4 text-lg text-gray-500 sm:mt-3">
                  נשמח לשמוע מכם! השאירו פרטים בטופס או שלחו לנו דוא"ל.
                </p>
                <form
                  action="#"
                  method="POST"
                ...
                >
                  ...
                  <div className="sm:col-span-2">
                    <button
                      type="submit"
                      className="w-full rounded-md bg-purple-600 px-4 py-2 text-white shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
                    >
                      שלח
                    </button>
                  </div>
